                ...
                <div class="filter-sidebar">
                    ...
                    <form method="GET" action="{{ route('customer.products.category', $category) }}">
                        ...
                        @if(request('search') || request('category') || request('price_range') || request('unit') || request('stock_status'))
                            <a href="{{ route('customer.products.category', $category) }}" class="btn btn-outline-secondary btn-clear w-100 mt-2">
            ...
            <div class="col-lg-9">
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card product-card">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="sold-per-info mb-2">
                                            <span class="unit-info-badge">
                ...
                @else
                    <div class="no-products">
                        ...
                        <h5>No Products Found in {{ $category->name ?? 'this category' }}</h5>
